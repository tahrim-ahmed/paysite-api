...
export class ResponseService {
    ...
    async toDtoResponse<T extends BaseDto>(status: HttpStatus, message: string, data: Promise<T>): Promise<ResponseDto> {
        const apiData = await data;
    ...
    async toDtosResponse<T extends BaseDto>(status: HttpStatus, message: string, data: Promise<T[]>): Promise<ResponseDto> {
        const apiData = await data;
